...
namespace tabular {
  ...
  Config::Config() : alignment(Alignment::Left), delimiter("-") {}
  ...
  String Config::getDelimiter() const { return this->delimiter; }
  ...
  void Config::setDelimiter(String delimiter) { this->delimiter = std::move(delimiter); }
}
