...
namespace tabular {
  ...
  std::vector<Color> Config::getColors() const { return this->colors; }
  std::vector<Color> Config::getBackColors() const { return this->back; }

  Color Config::getBaseColor() const { return this->base; }
